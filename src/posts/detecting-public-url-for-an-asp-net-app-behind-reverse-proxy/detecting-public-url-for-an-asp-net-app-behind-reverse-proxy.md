---
title: Detecting public URL for an ASP.NET app behind reverse proxy
...
I have to wait until the first request to find out the actual URL that reaches the app.
...
I would still have to get the URL somehow.
...
It's then registered into DI container as a singleton.
